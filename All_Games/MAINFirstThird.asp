						...
						<td>
							<TABLE align=center border=0 cellPadding=0 cellSpacing=0>
								<TR>
									...
									<TD><A href="../<%=AppendQuery("All_Games/Games.asp")%>"  onmouseout=MM_swapImgRestore() onmouseover="MM_swapImage('Image109','','../Pictures/HomeHighlighted.gif',1)"><IMG border=0 height=21 name=Image109 src="../Pictures/HomeHighlighted.gif"  alt="All Games"></A></TD>
