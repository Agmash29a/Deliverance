						...
						<td>
							<TABLE align=center border=0 cellPadding=0 cellSpacing=0>
								<TR>
									...
									<TD><A href="../<%=AppendQuery("PC_Games/Games.asp")%>" onmouseout=MM_swapImgRestore() onmouseover="MM_swapImage('Image10311','','../Pictures/PCHighlighted.gif',1)"><IMG border=0 height=21 name=Image10311 src="../Pictures/PCHighlighted.gif"  alt="PC Games"></A></TD>
									<TD><IMG height=21 src="../Pictures/MiddleBar.gif" width=23></TD>
