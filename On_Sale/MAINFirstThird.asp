						...
						<td>
							<TABLE align=center border=0 cellPadding=0 cellSpacing=0>
								<TR>
									...
									<TD><IMG height=21 src="../Pictures/MiddleBar.gif" width=23></TD>
									<TD><A href="../<%=AppendQuery("On_Sale/Games.asp")%>" onmouseout=MM_swapImgRestore() onmouseover="MM_swapImage('Image111','','../Pictures/OnSaleHighlighted.gif',1)"><IMG border=0 height=21 name=Image111 src="../Pictures/OnSaleHighlighted.gif" alt="On Sale"></A></TD>
									<TD><IMG height=21 src="../Pictures/FillBar.gif" ></TD>
	                			</TR>
	                		</TABLE>
