						...
						<td>
							<TABLE align=center border=0 cellPadding=0 cellSpacing=0>
								<TR>
									...
									<TD><IMG height=21 src="../Pictures/MiddleBar.gif" width=23></TD>
									<TD><A href="../<%=AppendQuery("Nintendo_Games/Games.asp")%>" onmouseout=MM_swapImgRestore() onmouseover="MM_swapImage('Image1123','','../Pictures/NintendoHighlighted.gif',1)"><IMG border=0 height=21 name=Image1123 src="../Pictures/NintendoHighlighted.gif" alt="Nintendo Games" ></A></TD>
									<TD><IMG height=21 src="../Pictures/MiddleBar.gif" width=23></TD>
