						...
						<td>
							<TABLE align=center border=0 cellPadding=0 cellSpacing=0>
								<TR>
									...
									<TD><IMG height=21 src="../Pictures/MiddleBar.gif" width=23></TD>
									<TD><A href="../<%=AppendQuery("PlayStation_Games/Games.asp")%>" onmouseout=MM_swapImgRestore() onmouseover="MM_swapImage('Image1144','','../Pictures/Ps1Ps2Highlighted.gif',1)"><IMG border=0 height=21 name=Image1144 src="../Pictures/ps1ps2Highlighted.gif" alt="PlayStation Games" ></A></TD>
									<TD><IMG height=21 src="../Pictures/MiddleBar.gif" width=23></TD>
