						...
						<td>
							<TABLE align=center border=0 cellPadding=0 cellSpacing=0>
								<TR>
									...
									<TD><IMG height=21 src="../Pictures/MiddleBar.gif" width=23></TD>
									<TD><A href="../<%=AppendQuery("DVD/Games.asp")%>" onmouseout=MM_swapImgRestore() onmouseover="MM_swapImage('Image112','','../Pictures/DVDHighlighted.gif',1)"><IMG border=0 height=21 name=Image112 src="../Pictures/DVDHighlighted.gif"alt="DVDs"></A></TD>
									<TD><IMG height=21 src="../Pictures/MiddleBar.gif" width=23></TD>
