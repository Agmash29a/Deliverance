						...
						<td>
							<TABLE align=center border=0 cellPadding=0 cellSpacing=0>
								<TR>
									...
									<TD><IMG height=21 src="../Pictures/MiddleBar.gif" width=23></TD>
									<TD><A href="../<%=AppendQuery("Electronics/Games.asp")%>" onmouseout=MM_swapImgRestore() onmouseover="MM_swapImage('Image10711','','../Pictures/ElectronicsHighlighted.gif',1)"><IMG border=0 height=21 name=Image10711 src="../Pictures/ElectronicsHighlighted.gif" alt="Electronics"></A></TD>
									<TD><IMG height=21 src="../Pictures/MiddleBar.gif" width=23></TD>
